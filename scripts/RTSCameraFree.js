...
function Update () {
    ...
    if ( Input.GetKey("mouse 2") ) {
        ...
        if ( Input.GetKey("d") || Input.mousePosition.x >= Screen.width * (1 - ScrollEdge) ) {
            transform.Translate(
                Time.deltaTime * ScrollSpeed *System.Math.Cos((Camera.main.transform.rotation.eulerAngles.y)*System.Math.PI/180),
                0,
                Time.deltaTime * -ScrollSpeed *System.Math.Sin((Camera.main.transform.rotation.eulerAngles.y)*System.Math.PI/180),
                Space.World
            );
